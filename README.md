...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-22 04:32`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b601e6aa-f241-4f2e-b600-4de0ddb31e1e.git
$ cd b601e6aa-f241-4f2e-b600-4de0ddb31e1e
```
